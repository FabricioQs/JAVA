...
public class TestPlato {
	...
	public static void main(String[] args) {
		...
		System.out.println("============Plato A: Valores asignado===========");
		
		platoA.nombre = "Empanadas de verde con queso";
		platoA.tipo = "Entrada";
		platoA.precio = 1.50;
		...
		System.out.println("============Plato B: Valores asignado===========");
		
		platoB.nombre = "Churrasco";
...
System.out.println("============Plato C: Valores asignado===========");
		
		platoC.nombre = "Gelatia";
		platoC.tipo = "Postre";
		platoC.precio = 1;
